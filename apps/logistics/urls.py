...
urlpatterns = [
    ...
    path('api/conference/items/<int:session_id>/', views.GetConferenceItemsView.as_view(), name='conference_items'),
    path('logistica/conferencia/terminar/<int:session_id>/', views.FinishConferenceView.as_view(), name='finish_conference'),
    ...
    path('api/conference/session/<int:session_id>/event/', views.conference_session_event, name='conference_session_event'),
